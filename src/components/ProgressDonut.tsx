...
import { CHART_COLORS, chartTooltipProps } from '../styles/chartTheme';
...
const COLORS = [CHART_COLORS.success, CHART_COLORS.primary, CHART_COLORS.danger];
...
export default function ProgressDonut({ stats, className = '' }: ProgressDonutProps) {
  ...
  return (
    <div className={`panel-card p-5 flex flex-col ${className}`}>
      <h3 className="panel-title mb-3">진행 현황</h3>
      <div className="relative flex-1 min-h-[140px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="text-center">
            ...
            <div className="text-lg font-bold text-gray-900">{stats.total}명</div>
          </div>
        </div>
      </div>
